...
fn testnet_trustees() -> Vec<(
    ...
    let btc_trustees = vec![
        btc_trustee_gen(
            "Alice",
            "02df92e88c4380778c9c48268460a124a8f4e7da883f80477deaa644ced486efc6", // hot key
            "0386b58f51da9b37e59c40262153173bdb59d7e4e45b73994b99eec4d964ee7e88", // colde key
        ),
        btc_trustee_gen(
            "Bob",
